...
export default function NavBar() {
    ...
    const css = {
        visibility: toggle ? 'top-[9%]' : 'top-[-100%]',
    }

    return (
        <header className='max-w-[100vw] text-white h-[60px] md:shadow-lg '>
            <nav className='flex flex-col md:flex-row justify-between w-[100%] h-[100%]'>
                <div className='logo-container md:mt-0 mt-3 flex w-[100%] h-[100%] items-center ml-5'>
                    ...
                    <span className='md:text-2xl text-xl font-righteous '>Uncharted Musings</span>
                </div>
                ...
                <div className={`w-full bg-[#0f0f0f] md:w-[38%] z-20 absolute md:static ${css.visibility} md:ml-3 md:shadow-none shadow-2xl`}>
